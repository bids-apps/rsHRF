...
def test_Fit_sFIR2():
    ...
    out1_exp = np.asarray(
        [
            -0.006013666009659839,
            -0.021447182383702836,
            -0.023945735843657407,
            -0.018371231986189136,
            -0.02233574736823547,
            -0.020078382177641022,
            0.010920928033064338,
            0.051249693019481325,
            0.06888676660465594,
            0.06398005690442186,
            0.048868321199953546,
            0.07298304109849973,
            0.3096652201182815,
        ]
    )
...
def test_wgr_FIR_estimation_HRF():
    ...
    para = {
        "estimation": "sFIR",
        "passband": [0.01, 0.08],
        "passband_deconvolve": [0.0, 1.7976931348623157e308],
        "TR": 2.0,
        "T": 1,
        "T0": 3,
        "TD_DD": 2,
        "AR_lag": 1,
        "thr": np.asarray([1.0, np.inf]),
        "temporal_mask": [],
        "order": 3,
        "len": 24,
        "min_onset_search": 4,
        ...
        "lag": np.asarray([6, 7, 8, 9, 10, 11, 12]),
    }
    N = 152
