...
class InputWindow:
    def __init__(self):
        ...
        # defining widgets
        inputFormat = Checkbutton(
            window,
            text="BIDS Format",
            variable=self.inputFormatVar,
            command=inputFormatButtonState,
        )
        maskFormat = Checkbutton(
            window,
            text="Mask File in BIDS",
            variable=self.maskFormatVar,
            state=DISABLED,
